...
export const policies = pgTable("policies", {
  ...
  premium_frequency: text("premium_frequency").$type<"monthly" | "quarterly" | "annual">().notNull(),
...
export const exchange_rates = pgTable("exchange_rates", {
  ...
  rate_to_inr: doublePrecision("rate_to_inr").notNull(), // 1 unit of from_currency = rate_to_inr INR
...
export const recurring_transactions = pgTable("recurring_transactions", {
  ...
  frequency: text("frequency").$type<"weekly" | "monthly" | "quarterly" | "annual">().notNull(),
